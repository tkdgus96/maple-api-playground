...
const characterApi = {
  ...
  async getBasicInfo(ocid: string, date?: string | null) {
  ...
  async getPopularityInfo(ocid: string, date?: string | null) {
  ...
  async getStatInfo(ocid: string, date?: string | null) {
  ...
  async getHyperStatInfo(ocid: string, date?: string | null) {
  ...
  async getPropensityInfo(ocid: string, date?: string | null) {
  ...
  async getItemEquipmentInfo(ocid: string, date?: string | null) {
  ...
  async getCashItemEquipmentInfo(ocid: string, date?: string | null) {
  ...
  async getSymbolEquipmentInfo(ocid: string, date?: string | null) {
  ...
  async getSetEffectInfo(ocid: string, date?: string | null) {
  ...
  async getBeautyEquipmentInfo(ocid: string, date?: string | null) {
  ...
  async getAndroidEquipmentInfo(ocid: string, date?: string | null) {
  ...
  async getPetEquipmentInfo(ocid: string, date?: string | null) {
  ...
  async getSkillInfo(ocid: string, date?: string | null) {
  ...
  async getLinkSkillInfo(ocid: string, date?: string | null) {
  ...
  async getVMatrixInfo(ocid: string, date?: string | null) {
  ...
  async getHexaMatrixInfo(ocid: string, date?: string | null) {
  ...
  async getHexaStatInfo(ocid: string, date?: string | null) {
  ...
  async getDojangInfo(ocid: string, date?: string | null) {
